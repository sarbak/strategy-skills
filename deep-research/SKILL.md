...
**This process has 8 steps. Complete every step in order. Do not skip steps. When reporting progress, label each step as shown (e.g., "Step 3/8").**

---

## Step 1/8 -- Determine research questions
...
## Step 2/8 -- Check for overlap with existing work
...
## Step 3/8 -- Verify the question hierarchy
...
## Step 4/8 -- Research Level 0-1 questions

For each question at Level 0-1:

### Step 4a/8 -- Form a specific query
...
## Step 5/8 -- Assess whether to proceed

After Level 0-1 answers come back:
- If confirmed -> proceed to Level 2-3 questions in Step 6/8
...
## Step 6/8 -- Research Level 2-4 questions

Repeat the same sub-steps as Step 4/8 (form query -> execute -> record) for each remaining question at Levels 2-4. After each level, reassess whether the lower-level questions are still relevant.

## Step 7/8 -- Write the results document
